...
<div className="second-main">
    <div className="inner-second-main">

<div className="second-main-text">
<h1 className="falu">Or Subscribe to the Newsletter</h1>
<div className="para-main">
<p className="left-para">Email address    </p>

<p className="right-para">Submit</p>
</div>
...
<div className="malu">
     <h1 className="falu">Follow Products and Discounts on Instagram</h1>
