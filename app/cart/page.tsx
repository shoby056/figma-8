      ...
      <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-10">
            ...
            <div className="flex flex-col md:flex-row items-center md:justify-between p-4 bg-white shadow rounded-lg">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <i className="fa-regular fa-heart text-2xl cursor-pointer hover:text-red-500" aria-hidden="true"></i>
                  <i className="fa-regular fa-trash-can text-2xl cursor-pointer hover:text-gray-500" aria-hidden="true"  ></i>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full md:w-1/3 flex flex-col justify-center items-center gap-6 bg-white shadow rounded-lg p-6">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="flex justify-between text-lg md:text-base border-b-2 border-gray-100 pb-4">
              <span>Estimate Delivery & Handling</span>
              <span>Free</span>
            </div>
            <div className="flex justify-between text-xl md:text-lg font-semibold border-b-2 border-gray-100 pb-4">
              <span>Total</span>
              <span >$198.00</span>
